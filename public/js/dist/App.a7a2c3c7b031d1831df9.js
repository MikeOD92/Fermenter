...
"use strict";
eval("/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"a\", function() { return EditLactoFerment; });\n/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ \"./node_modules/react/index.js\");\n/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\nfunction EditLactoFerment(props) {\n  const [lactoferment, setlactoFerment] = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useState\"])({});\n  const [didDelete, setDidDelete] = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useState\"])({});\n  const volumeVal = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useRef\"])(null);\n  const volumeUnit = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useRef\"])(null);\n  const fermentTemp = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useRef\"])(null);\n  const fermentDuration = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useRef\"])(null);\n  const saltAmount = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useRef\"])(null);\n  const saltUnit = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useRef\"])(null);\n  const mainName = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useRef\"])(null);\n  const mainUnit = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useRef\"])(null);\n  const mainValue = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useRef\"])(null);\n  const otherName = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useRef\"])(null);\n  const otherValue = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useRef\"])(null);\n  const otherUnit = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useRef\"])(null);\n  const name = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useRef\"])(null);\n  const description = Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useRef\"])(null);\n  Object(react__WEBPACK_IMPORTED_MODULE_0__[\"useEffect\"])(() => {\n    _asyncToGenerator(function* () {\n      try {\n        const response = yield fetch(\"/api/lactoferments/\".concat(props.match.params.id));\n        const data = yield response.json();\n        setlactoFerment(data);\n        console.log(lactoferment);\n        console.log(\"this is the volume.val \".concat(lactoferment.volume.val));\n      } catch (error) {\n        console.error(error);\n      }\n    })();\n  }, []);\n\n  const handleSubmit = /*#__PURE__*/function () {\n    var _ref2 = _asyncToGenerator(function* (e) {\n      e.preventDefault;\n      const volumeValVal = volumeVal.current.value;\n      const volumeUnitVal = volumeUnit.current.value;\n      const fermentTempVal = fermentTemp.current.value;\n      const fermentDurationVal = fermentDuration.current.value;\n      const saltValueVal = saltAmount.current.value;\n      const saltUnitVal = saltUnit.current.value;\n      const mainNameVal = mainName.current.value;\n      const mainUnitVal = mainUnit.current.value;\n      const mainValueVal = mainValue.current.value;\n      const otherNameVal = otherName.current.value;\n      const otherValueVal = otherValue.current.value;\n      const otherUnitVal = otherUnit.current.value;\n      const nameVal = name.current.value;\n      const descriptionVal = description.current.value;\n\n      try {\n        const response = yield fetch('/api/lactoferments', {\n          method: 'PUT',\n          headers: {\n            'Content-Type': 'application/json'\n          },\n          body: JSON.stringify({\n            name: nameVal,\n            description: descriptionVal,\n            volume: {\n              val: volumeValVal,\n              unit: volumeUnitVal\n            },\n            method: {\n              ferment: {\n                temp: fermentTempVal,\n                duration: fermentDurationVal\n              }\n            },\n            ingredients: {\n              salt: {\n                amount: {\n                  value: saltValueVal,\n                  unit: saltUnitVal\n                }\n              },\n              main: [{\n                amount: {\n                  value: mainValueVal,\n                  unit: mainUnitVal\n                },\n                name: mainNameVal\n              }],\n              other: [{\n                amount: {\n                  value: otherValueVal,\n                  unit: otherUnitVal\n                },\n                name: otherNameVal\n              }]\n            }\n          })\n        });\n        const data = yield response.json();\n        setlactoFerment([data]);\n      } catch (error) {\n        console.error(error);\n      }\n    });\n\n    return function handleSubmit(_x) {\n      return _ref2.apply(this, arguments);\n    };\n  }(); // const handleDelete = async e => {\n  // \ttry {\n  // \t\tconst response = await fetch(\n  // \t\t\t`/api/lacoferments${props.match.params.id}`,\n  // \t\t\t{\n  // \t\t\t\tmethod: 'DELETE',\n  // \t\t\t\theader: {\n  // \t\t\t\t\t'Content-Type': 'application/json'\n  // \t\t\t\t}\n  // \t\t\t}\n  // \t\t);\n  // \t\tconst data = await response.json();\n  // \t\tsetDidDelete(!didDelete);\n  // \t} catch (error) {\n  // \t\tconsole.error(error);\n  // \t} finally {\n  // \t\twindow.location.assign('/');\n  // \t}\n  // };\n\n\n  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"div\", {\n    className: \"newLactofermentForm\"\n  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"form\", {\n    onSubmit: handleSubmit\n  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"label\", null, \"Recipe Name\", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"input\", {\n    type: \"text\",\n    ref: name\n  }, lactoferment.name)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"label\", null, \"Description\", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"input\", {\n    type: \"text\",\n    ref: description\n  }, lactoferment.description)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"label\", null, \"Volume amount\", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"input\", {\n    type: \"number\",\n    ref: volumeVal\n  }, lactoferment.volume.val)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"label\", null, \"Volume unit\", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"input\", {\n    type: \"text\",\n    ref: volumeUnit\n  }, ' ', lactoferment.volume.unit, ' ')), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"label\", null, \"Fermentaion temp \", \"(C)\", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"input\", {\n    type: \"text\",\n    ref: fermentTemp\n  }, lactoferment.method.ferment.temp)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"label\", null, \"Fermentation duration\", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"input\", {\n    type: \"text\",\n    ref: fermentDuration\n  }, lactoferment.method.ferment.duration)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"label\", null, \"Main ingredient\", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"input\", {\n    type: \"text\",\n    ref: mainName\n  }, lactoferment.ingredients.main[0].name)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"label\", null, \"Main amount\", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"input\", {\n    type: \"text\",\n    ref: mainValue\n  }, lactoferment.ingredients.main[0].amount.value)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"label\", null, \"Main unit\", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"input\", {\n    type: \"text\",\n    ref: mainUnit\n  }, lactoferment.ingredients.main[0].amount.unit)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"label\", null, \"salt amount\", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"input\", {\n    type: \"number\",\n    ref: saltAmount,\n    defaultValue: lactoferment.ingredients.salt.amount.value\n  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"label\", null, \"salt unit\", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"input\", {\n    type: \"text\",\n    ref: saltUnit\n  }, lactoferment.ingredients.salt.amount.unit)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"label\", null, \"Other name\", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"input\", {\n    type: \"text\",\n    ref: otherName\n  }, lactoferment.ingredients.other[0].name)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"label\", null, \"other amount\", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"input\", {\n    type: \"number\",\n    ref: otherValue\n  }, lactoferment.ingredients.other[0].amount)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"label\", null, \"other unit\", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"input\", {\n    type: \"text\",\n    ref: otherUnit\n  }, lactoferment.ingredients.other[0].unit)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"label\", null, \"update Fermentaion recipe\", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"input\", {\n    type: \"submit\"\n  }))));\n}\n\n//# sourceURL=webpack:///./src/pages/LactoRecipeEdit.js?");
